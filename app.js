...
function renderSettingsCard() {
  ...
  settings.innerHTML = `
    ...
    <section id="helpBlock" class="card helpCard">
      ...
      <details class="helpGroup">
        <summary>Ежедневная практика</summary>
        <div class="helpContent">
          <ol>
            <li>Открой нужный день в календаре.</li>
            <li>Прочитай подсказку и выполни шаги по порядку: дыхание, подготовка и массаж.</li>
            <li>Отметь каждый выполненный шаг или нажми «Завершить день» после практики.</li>
            <li>После завершения можно добавить заметку и выбрать результат занятия.</li>
            <li>Кнопка «К календарю» возвращает к списку дней.</li>
          </ol>
        </div>
      </details>
      ...
      <details class="helpGroup">
        ...
        <div class="helpContent">
          ...
          <p>История хранится на этом устройстве. Перед очисткой данных браузера открой «Настройки» → нажми «Экспорт» и сохрани JSON-файл. Для восстановления используй «Импорт».</p>
        </div>
      </details>
    </section>
  `;
